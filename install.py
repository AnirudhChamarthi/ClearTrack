...
def setup_config():
    ...
    print("This should NOT be the same repository. Please create a new repository, such as ClearTrackReceiver.")
    print("Please create a new repository, such as ClearTrackReceiver.")
